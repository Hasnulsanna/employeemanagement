...
def addemployees(request):
    if request.method=='POST':
        ...
        addemp(name=name,address=address,age=age,salary=salary,designation=designation,phonenumber=phonenumber,email=email).save()
        redirect('/')
...
def viewemployees(request):
    cr = addemp.objects.all()
    return render(request,"viewemployees.html",{'cr':cr})